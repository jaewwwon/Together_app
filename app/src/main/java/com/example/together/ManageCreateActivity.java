...
public class ManageCreateActivity extends AppCompatActivity {

    //속성(변수) 선언
    private static String TAG = "ManageCreateActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        homeNav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ManageCreateActivity.this, MainActivity.class);
        ...
        manageNav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManageCreateActivity.this, ManageJoinActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        ...
        settingNav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManageCreateActivity.this, SettingActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
        ...
        groupCreateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ManageCreateActivity.this, ManageCreateActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                overridePendingTransition(0, 0);
            }
    ...
    private void manageInit() {
        RecyclerView recyclerView = findViewById(R.id.createGroupList);
    ...
    private class GetJoinGroupData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ManageCreateActivity.this,
...
//            Log.e(TAG, "response - " + result);
        ...
        protected String doInBackground(String... params) {
            ...
            String postParameters = "userLoginEmail=" + loginUserId + "&whereTxt=" + "ORDER BY group_idx DESC";
    ...
    private void groupResult() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String groupStart = item.getString(TAG_GROUP_START);
                ...
                data.setGroupDate(getDateFormat(groupStart, "yyyy-MM-dd HH:mm:ss", "yyyy.MM.dd"));
//                Log.e(TAG, "날짜 기존값 : " + groupStart);
//                Log.e(TAG, "날짜 변경값 : " + getDateFormat(groupStart, "yyyy-MM-dd HH:mm:ss", "yyyy.MM.dd"));
