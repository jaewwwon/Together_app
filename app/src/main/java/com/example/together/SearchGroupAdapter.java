...
public class SearchGroupAdapter extends RecyclerView.Adapter<SearchGroupAdapter.ItemViewHolder> {
...
//            groupThumbnail.setImageURI(Uri.parse(data.getGroupThumbnail()));
